...
![User Stories](media/e9e0ab4bc03d179d39bda194778a7850.png)
...
![Home Screen](media/d62b92a47ea67105ff086e7dfc2551e2.png)![Store Page](media/2f5041ca8ba9fd24eac6ed3833008094.png)


![Stats Screen](media/7d7b739dfb8134598f58721e04aed4f0.png)![Settings](media/02c543d4285364ceb6363e96d3de6786.png)


### Use Case Diagram

**![Use Case Diagram](media/0a98089b7008e0dd71de509325b8c26b.png)**
...
2.  A new player launches the game
...
3.  Player upgrades mining speed
...
4.  Player upgrades and or buys auto clickers

When the player opens the shop, they are presented with multiple buttons displaying purchasable upgrades. The buttons are displayed in ascending order with multipliers: 1,10,100, and Max. Each button would have the following scheme:

*Where “x” would be the multiplier and GPU model “y” is the upgrade name*

5.  Player opens the options menu
